...
jsPsych.plugins["function-tap"] = (function() {
    var plugin = {};

    jsPsych.pluginAPI.registerPreload('function-tap', 'stimulus', 'audio');
    ...
    plugin.trial = function(display_element, trial) {
        ...
        for (var i = 0; i < trial.choices.length; i++) {
            display_element.querySelector('#jspsych-audio-button-response-button-' + i).addEventListener('touch', function(e){
                handleGesture(e);
